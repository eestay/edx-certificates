...
class CertificateGen(object):
    ...
    def _generate_v1_certificate(
        ...
        paragraph_string = "Santiago de Chile, a 20 de septiembre de 2017".format(self.issued_date)
...
#            styleOpenSans.leading = 21
        ...
        paragraph_string = "realizado entre el 8 de agosto y el 14 de septiembre de 2017<br/><br/>" \
